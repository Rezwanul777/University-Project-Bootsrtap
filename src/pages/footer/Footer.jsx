    ...
    return (
            ...
            <div className='d-row d-md-flex justify-content-between align-items-center'>
              <div className='col-12 col-md-6 col-lg-5 mb-5 mt-4 my-md-0'>
                <ul className='footer-navigation list-unstyled mb-0'>
                  ...
                  <Link to="/course" className='text-decoration-none text-danger'>
              ...
              <div className='col-12 col-md-6 col-lg-7'>
                <ul className='list-unstyled mb-0'>
                  ...
                  <li>
                    <p>Email - prince@university.co.uk</p>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div className='bg-body-tertiary'>
        <div className='container'>
          <p className='p-3 m-0 text-center'>&copy; 2024 University. All Right Reserved.</p>
        </div>
      </div>
    </footer> 
    {
